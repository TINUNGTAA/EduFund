    ...
    <section className="py-12 mt-10 lg:mt-20 bg-gray-50">
      <div className="fsm:w-3/4 lg:w-6/12 mx-auto px-2">
        ...
        <p className="text-gray-600">
          Get the app to start applying for funds. Funders can also download the
        ...
        <div className="flex flex-col lg:flex-row  items-center justify-center gap-6 mt-10">
          <a
            className="cursor-pointer flex min-w-max items-center justify-center transition duration-300 hover:bg-green-700 text-white bg-edufund-green py-3 px-6 rounded-sm "
